...
public class Main {
    public static void main(String[] Args){
        /*
        * Often times, you might want to get input from the user! Luckily for us, it is rather easy to do so.
        *
        * The first thing you have to do is import the Scanner library by typing import java.util.Scanner; at the very
        * top of your program.
        *
        ...
        *
        * For instance, if you request an integer from the user, and they input a letter, it will throw an exception
        ...
        *
        * It is often times useful to encase try-catch blocks within a do-while loop, since you will
        ...
        * process. However, the Scanner includes a method which does most of that work for us. The shorter and
        * more "correct" way is shown below:
        */
        System.out.print("Enter an integer: ");
        // requests our integer and returns false if an exception occurred. if true, set our buffer to use kbd.nextInt();
